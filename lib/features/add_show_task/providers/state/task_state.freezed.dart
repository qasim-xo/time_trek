...
mixin _$TaskState {
  ...
  List<Task> get filteredTaskList => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      taskList: null == taskList
          ...
          : taskList // ignore: cast_nullable_to_non_nullable
              as List<Task>,
      filteredTaskList: null == filteredTaskList
          ? _value.filteredTaskList
          : filteredTaskList // ignore: cast_nullable_to_non_nullable
              as List<Task>,
...
class _$TaskStateImpl implements _TaskState {
  _$TaskStateImpl(
      ...
      required final List<Task> filteredTaskList,
  ...
  List<Task> get filteredTaskList {
    if (_filteredTaskList is EqualUnmodifiableListView)
      return _filteredTaskList;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_filteredTaskList);
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._filteredTaskList, _filteredTaskList) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_filteredTaskList),
      selectedDate,
      priority,
      title,
      desc,
